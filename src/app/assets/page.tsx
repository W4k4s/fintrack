      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          <thead><tr className="text-muted text-xs uppercase tracking-wider border-b border-border">
            <th className="text-left py-3 px-5 font-medium cursor-pointer hover:text-foreground" onClick={()=>toggleSort("symbol")}>Asset <ArrowUpDown className="w-3 h-3 inline ml-1"/></th>
            <th className="text-left py-3 px-5 font-medium">Source</th>
            <th className="text-right py-3 px-5 font-medium cursor-pointer hover:text-foreground" onClick={()=>toggleSort("total")}>Amount <ArrowUpDown className="w-3 h-3 inline ml-1"/></th>
            <th className="text-right py-3 px-5 font-medium">Price</th>
            <th className="text-right py-3 px-5 font-medium cursor-pointer hover:text-foreground" onClick={()=>toggleSort("value")}>Value <ArrowUpDown className="w-3 h-3 inline ml-1"/></th>
